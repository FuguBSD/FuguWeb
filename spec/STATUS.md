...
| --------------------------------- | ------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [WEB-MANUALS](web.md#web-manuals) | partial | —       | [Config.pm](../lib/App/FuguWeb/Config.pm) reads the directory of a group, and orders its manuals. [Manual.pm](../lib/App/FuguWeb/Manual.pm) names each page, and [Index.pm](../lib/App/FuguWeb/Index.pm) writes one heading for each group. The section list `@SECTIONS` holds no `7`. The `.7` file set of WEB-MANUALS-1 is absent, and the `7` order of WEB-MANUALS-2 is absent. [index.t](../t/fuguweb/index.t)                                                                                |
