...
| [WEB-X509](web.md#web-x509)       | partial | —       | [Rotate.pm](../lib/App/FuguWeb/Rotate.pm) signs a binding of this type, per [rotate.t](../t/fuguweb/rotate.t), and [Keys.pm](../lib/App/FuguWeb/Keys.pm) holds its verifier. The import of WEB-X509-2 and each check of the certificate are absent. |
