# FuguWeb specification

FuguWeb builds one static documentation site from the documentation that a Perl
...
| Code | Document         | Area              |
| ---- | ---------------- | ----------------- |
| WEB  | [web.md](web.md) | The site renderer |
